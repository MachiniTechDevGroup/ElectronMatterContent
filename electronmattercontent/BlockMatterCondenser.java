...
public class BlockMatterCondenser extends BlockContainer
{
            ...
            float par9)
    {
        ...
        if (!world.isRemote)
        {
            TileEntityMatterCondenser te = (TileEntityMatterCondenser) world
                    .getBlockTileEntity(par2, par3, par4);

            if (te != null)
            {
                par5EntityPlayer.openGui(EMC.instance, 0, world, par2, par3,
                        par4);
            }
        }
    ...
    public static void update(boolean active, World par1World, int xCoord,
            int yCoord, int zCoord)
    {
        int l = par1World.getBlockMetadata(xCoord, yCoord, zCoord);
        TileEntity tileentity = par1World.getBlockTileEntity(xCoord, yCoord,
                zCoord);
            ...
            int par5, int par6)
    {
        if (!keepInventory)
        {
            TileEntityMatterCondenser tileentity = (TileEntityMatterCondenser) par1World
                    .getBlockTileEntity(par2, par3, par4);
            ...
            EntityLiving par5EntityLiving, ItemStack par6ItemStack)
    {
        ...
        {
            ((TileEntityMatterCondenser) par1World.getBlockTileEntity(par2,
                    par3, par4)).setName(par6ItemStack.getDisplayName());
        }
    }
